...
private:
    ...
    bool isFarEnough(const geometry_msgs::Pose& a, const geometry_msgs::Pose& b, double min_dist = 0.1) const;
...
// class SpawnManager{
//     public: 
//         SpawnManager(ros::NodeHandle& nh, const std::string& model_path);

//         bool spawnBox(const std::string& model_name, const geometry_msgs::Pose& pose);
//         bool deleteBox(const std::string& model_name);
//         geometry_msgs::Pose randomPose(float radius);

//     private:
//         std::string modelXML_;
//         ros::ServiceClient spawn_client_;
//         ros::ServiceClient delete_client_;
// };
